...
======================================*/
    ...
    // 3.Countdown timer 
        ...
        const makeTimer = () =>  {
            let endTime = ( Date.parse( new Date("January 1, 2021 16:07:53 GMT-0400") ) ) / 1000,
            ...
            ( hours < "10" ) ? hours = "0".concat(hours) : false;
            ( minutes < "10" ) ? minutes = "0".concat(minutes) : false;
            ( seconds < "10" ) ? seconds = "0".concat(seconds) : false;
            document.querySelector("#days").innerHTML = days + `<span class="camp">Days</span>`;
            document.querySelector("#hours").innerHTML = hours + `<span class="camp">Hour</span>`;
            document.querySelector("#minutes").innerHTML = minutes + `<span class="camp">Minute</span>`;
            document.querySelector("#seconds").innerHTML = seconds + `<span class="camp">Second</span>`;       
        }
